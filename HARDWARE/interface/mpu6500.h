...
bool mpu6500Init(void);	/*MPU6500初始化*/
bool mpu6500SelfTest(void);	/*MPU6500自检*/
void mpu6500GetRawData(s16* ax, s16* ay, s16* az, s16* gx, s16* gy, s16* gz);	/*获取6轴原始数据*/
