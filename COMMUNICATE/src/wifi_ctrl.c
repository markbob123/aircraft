...
static void wifiCmdProcess(u8 data)
{
	...
	if(getCommanderAltholdMode() == true)/*当前四轴飞行为定高模式*/
	{
...
static void wifiDataHandle(u8 *data)
{
	...
	wifiCtrl.roll   = ((float)data[1]-(float)0x80)*0.2f;	/*roll: ±7.6 ±15.4 ±25.4*/
	wifiCtrl.pitch  = ((float)data[2]-(float)0x80)*0.2f;	/*pitch:±7.6 ±15.4 ±25.4*/
